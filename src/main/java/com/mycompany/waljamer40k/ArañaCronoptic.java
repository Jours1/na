 ...
 * @author Jours
 */
public class ArañaCronoptic extends Juego{
      @Override
    ...
    double vidaRestante = p1.getVida()-getDaño()*plusDaño;
    ...
    public ArañaCronoptic(int vida, int daño, int fichas, int defensa, String NombreDelJugador ){
