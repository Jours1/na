 ...
 * @author Jours
 */
public class Blindados extends Juego{
     @Override
    ...
    double vidaRestante = p1.getVida()+plusDefensa-getDaño()*plusDaño;
...
public Blindados (int vida, int daño, int fichas, int defensa, String NombreDelJugador){
